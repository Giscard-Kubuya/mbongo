$(function () {
    ...
    $.ajax({
         url:"Dashboard/compteur",
            method:"post",
            dataType:"json",
            success:function(dt){
                //$('#compteurClient').html(dt.compteurClient);
               chartjs(dt.hour2,dt.profit) 
            }
    })
});

let chartjs = function(dt1,dt2){
    var d6_1 = [["Janv", 67],["Feb", 91],["Mar", 36],["Apr", 150],["May", 28],["Jun", 123],["Jul", 38]];
    var d6_2 = [["Janv", 59],["Feb", 49],["Mar", 45],["Apr", 94],["May", 76],["Jun", 22],["Jul", 31]];

    $.plot("#area-chart-spline2", [{
        data: d6_1,
        label: "Upload",
        color: "#ffce54"
    },{
