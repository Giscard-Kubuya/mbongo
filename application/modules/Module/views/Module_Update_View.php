                                          ...
                                          <h3>Modification du groupe</h3>
                                           <form action="" id="formid" name="formid">
                                               <div class="form-group">
                                                   <label for="nom" class="control-label">Nom du groupe:</label>
                                                   <input type="text" id="nom" value="<?=$data['NOM_GROUPE'] ?>" name="nom" class="form-control">
                                               </div>
                                               <div class="form-group">
                                                   <label for="tel" class="control-label">Telephone:</label>
                                                   <input type="tel" value="<?=$data['TELEPHONE'] ?>" id="tel" name="tel" class="form-control">
                                               </div>
                                               <div class="form-group">
                                                   ...
                                                   <input type="hidden" id="Id" value="<?=$data['ID_GROUPE'] ?>" name="Id" >
                                               </div>
                                           </form>
