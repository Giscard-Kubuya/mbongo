                        ...
                        <!-- +++++++++++++++++++++++ -->
                         <?=$this->load->view('panel_head')?>
                            <div class="panel-body">
                                ...
                                <div class="panel-heading">Ajouter un compte de gestion</div>
                                <div class="panel-body pan">
                                    <form id="formId" method="post" name="formId">
                                        <div class="form-body pal">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group"><label for="Matricule" class="control-label">Matricule</label>
