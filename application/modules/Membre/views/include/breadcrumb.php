	...
	<nav aria-label="breadcrumb">
	    <ol class="breadcrumb">
	        ...
	        <div class="ml-auto text-right">
	        	<?php if ($membres): ?>
                <li class="breadcrumb-item"><a data-toggle="tooltip" title="Envoyer au groupe"  href="#"><i data-target="#groupSender" data-toggle="modal" class="fa fa-question-circle fa-lg"></i></a>  /
                	<a data-toggle="tooltip" title="Créer un Module"  href="#"><i data-target="#setting" data-toggle="modal" class="fa fa-cog fa-lg"></i></a></li>
	        	<?php endif ?>
            </div>
	    </ol>
	</nav>
