                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group"><label for="Devise" class="control-label">Devise(Nom entier)</label>
                                                        <div class="input-icon right"><i class="fa fa-money"></i><input id="Devise" name="Devise" type="text" placeholder="ex@ Dollars" class="form-control" /></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group"><label for="Abbr" class="control-label">Devise en Abbreviation</label>
                                                        <div class="input-icon right"><i class="fa fa-money"></i><input id="Abbr" name="Abbr" type="text" placeholder="ex@ FB ,FC ,$" class="form-control" /></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group"><label for="Pays" class="control-label">Pays</label>
                                                        <div class="input-icon right"><i class="fa fa-globe"></i>
                                                            <select  class="form-control custom-select" name="Pays" id="Pays"><option value="">---Selectionnez un pays---</option>
                                                                <?= $pays ?>
                                                            </select>
                                                        </div>
                                                    </div>
